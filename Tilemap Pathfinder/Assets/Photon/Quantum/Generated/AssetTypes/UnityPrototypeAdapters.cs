...
namespace Quantum.Prototypes.Unity {
  ...
  [Quantum.Prototypes.PrototypeAttribute(typeof(Quantum.AIDecision))]
  public class AIDecision_Prototype : Quantum.PrototypeAdapter<Quantum.Prototypes.AIDecision_Prototype> {
    [Quantum.LocalReference]
    public global::EntityPrototype CurrentTarget;
    [Quantum.Inspector.DictionaryAttribute()]
    [Quantum.Inspector.DynamicCollectionAttribute()]
    public DictionaryEntry_EntityRef_Int32_Prototype[] Targets = System.Array.Empty<DictionaryEntry_EntityRef_Int32_Prototype>();

    public sealed override Quantum.Prototypes.AIDecision_Prototype Convert(EntityPrototypeConverter converter) {
      var result = new Quantum.Prototypes.AIDecision_Prototype();
      converter.Convert(this.CurrentTarget, out result.CurrentTarget);
      result.Targets = System.Array.ConvertAll(this.Targets, x => x.Convert(converter));
      return result;
    }
  }
  [System.SerializableAttribute()]
  ...
  [System.SerializableAttribute()]
  [Quantum.Prototypes.PrototypeAttribute(typeof(Quantum.ItemsInTile))]
  public class ItemsInTile_Prototype : Quantum.PrototypeAdapter<Quantum.Prototypes.ItemsInTile_Prototype> {
    [Quantum.Inspector.DynamicCollectionAttribute()]
    [Quantum.LocalReference]
    public global::EntityPrototype[] Items = System.Array.Empty<global::EntityPrototype>();

    public sealed override Quantum.Prototypes.ItemsInTile_Prototype Convert(EntityPrototypeConverter converter) {
      var result = new Quantum.Prototypes.ItemsInTile_Prototype();
      result.Items = System.Array.ConvertAll(this.Items, x => { converter.Convert(x, out Quantum.MapEntityId tmp); return tmp; });
      return result;
    }
  }
  [System.SerializableAttribute()]
  ...
  public class SearchData_Prototype : Quantum.PrototypeAdapter<Quantum.Prototypes.SearchData_Prototype> {
    ...
    public sealed override Quantum.Prototypes.SearchData_Prototype Convert(EntityPrototypeConverter converter) {
      var result = new Quantum.Prototypes.SearchData_Prototype();
