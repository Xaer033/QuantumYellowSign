...
namespace Quantum {
  ...
  [StructLayout(LayoutKind.Explicit)]
  [Quantum.AssetRefAttribute(typeof(ProjectileConfig))]
  [System.SerializableAttribute()]
  public unsafe partial struct AssetRefProjectileConfig : IEquatable<AssetRefProjectileConfig>, IAssetRef<ProjectileConfig> {
    public const Int32 SIZE = 8;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(0)]
    public AssetGuid Id;
    ...
    public static implicit operator AssetRefProjectileConfig(ProjectileConfig value) {
      var r = default(AssetRefProjectileConfig);
      if (value != null) {
        r.Id = value.Guid;
      }
      return r;
    ...
    public override Boolean Equals(Object obj) {
      return obj is AssetRefProjectileConfig other && Equals(other);
    }
    public Boolean Equals(AssetRefProjectileConfig other) {
      return Id.Equals(other.Id);
    }
    public static Boolean operator ==(AssetRefProjectileConfig a, AssetRefProjectileConfig b) {
      return a.Id == b.Id;
    }
    public static Boolean operator !=(AssetRefProjectileConfig a, AssetRefProjectileConfig b) {
      return a.Id != b.Id;
    ...
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (AssetRefProjectileConfig*)ptr;
        AssetGuid.Serialize(&p->Id, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  ...
  [StructLayout(LayoutKind.Explicit)]
  [Quantum.AssetRefAttribute(typeof(TowerConfig))]
  [System.SerializableAttribute()]
  public unsafe partial struct AssetRefTowerConfig : IEquatable<AssetRefTowerConfig>, IAssetRef<TowerConfig> {
    public const Int32 SIZE = 8;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(0)]
    public AssetGuid Id;
    ...
    public static implicit operator AssetRefTowerConfig(TowerConfig value) {
      var r = default(AssetRefTowerConfig);
      if (value != null) {
        r.Id = value.Guid;
      }
      return r;
    ...
    public override Boolean Equals(Object obj) {
      return obj is AssetRefTowerConfig other && Equals(other);
    }
    public Boolean Equals(AssetRefTowerConfig other) {
      return Id.Equals(other.Id);
    }
    public static Boolean operator ==(AssetRefTowerConfig a, AssetRefTowerConfig b) {
      return a.Id == b.Id;
    }
    public static Boolean operator !=(AssetRefTowerConfig a, AssetRefTowerConfig b) {
      return a.Id != b.Id;
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct EndGoal : Quantum.IComponent {
  ...
  public unsafe partial struct Projectile : Quantum.IComponent {
    ...
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(0)]
    public AssetRefProjectileConfig Config;
    [FieldOffset(16)]
    [ExcludeFromPrototype()]
    public FP Damage;
    [FieldOffset(40)]
    ...
    public override Int32 GetHashCode() {
      unchecked { 
        ...
        hash = hash * 31 + SelfDestructTimer.GetHashCode();
        hash = hash * 31 + Speed.GetHashCode();
        hash = hash * 31 + TargetEntityRef.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (Projectile*)ptr;
        Quantum.AssetRefProjectileConfig.Serialize(&p->Config, serializer);
        EntityRef.Serialize(&p->TargetEntityRef, serializer);
        FP.Serialize(&p->Damage, serializer);
        FP.Serialize(&p->SelfDestructTimer, serializer);
  ...
  public unsafe partial struct Tower : Quantum.IComponent {
    ...
    [FieldOffset(8)]
    public AssetRefTowerConfig Config;
    [FieldOffset(24)]
    [ExcludeFromPrototype()]
    public FP Damage;
    [FieldOffset(32)]
    ...
    public override Int32 GetHashCode() {
      unchecked { 
        ...
        hash = hash * 31 + TargetEntityRef.GetHashCode();
        hash = hash * 31 + ThinkTickTimer.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (Tower*)ptr;
        serializer.Stream.Serialize(&p->AiState);
        Quantum.AssetRefTowerConfig.Serialize(&p->Config, serializer);
        EntityRef.Serialize(&p->TargetEntityRef, serializer);
        FP.Serialize(&p->Damage, serializer);
        FP.Serialize(&p->Health, serializer);
  ...
  public unsafe partial class Frame {
    ...
    private ISignalOnProjectileHit[] _ISignalOnProjectileHitSystems;
    ...
    static partial void InitStaticGen() {
      ComponentTypeId.Setup(() => {
        ...
        ComponentTypeId.Add<Quantum.EndGoal>(Quantum.EndGoal.Serialize, null, null, ComponentFlags.None);
    ...
    partial void InitGen() {
      ...
      _ISignalOnProjectileHitSystems = BuildSignalsArray<ISignalOnProjectileHit>();
      ...
      BuildSignalsArrayOnComponentAdded<Quantum.EndGoal>();
      BuildSignalsArrayOnComponentRemoved<Quantum.EndGoal>();
    ...
    public unsafe partial struct FrameSignals {
      ...
      public void OnProjectileSpawned(EntityRef entity, EntityRef spawningTower) {
        var array = _f._ISignalOnProjectileSpawnedSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.OnProjectileSpawned(_f, entity, spawningTower);
          }
        }
      }
      public void OnProjectileHit(EntityRef projectileEntity, EntityRef targetEntity, FP damage) {
        var array = _f._ISignalOnProjectileHitSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.OnProjectileHit(_f, projectileEntity, targetEntity, damage);
          }
        }
      }
    }
    ...
    public unsafe partial struct FrameAssets {
      ...
      public ProjectileConfig ProjectileConfig(AssetRefProjectileConfig assetRef) {
         return _f.FindAsset<ProjectileConfig>(assetRef.Id);
      }
      public TowerConfig TowerConfig(AssetRefTowerConfig assetRef) {
         return _f.FindAsset<TowerConfig>(assetRef.Id);
      }
    }
  }
  ...
  public unsafe interface ISignalOnProjectileSpawned : ISignal {
    void OnProjectileSpawned(Frame f, EntityRef entity, EntityRef spawningTower);
  }
  public unsafe interface ISignalOnProjectileHit : ISignal {
    void OnProjectileHit(Frame f, EntityRef projectileEntity, EntityRef targetEntity, FP damage);
  }
  ...
  public static unsafe partial class BitStreamExtensions {
    ...
    public static void Serialize(this IBitStream stream, ref AssetRefProjectileConfig value) {
      stream.Serialize(ref value.Id.Value);
    }
    ...
    public static void Serialize(this IBitStream stream, ref AssetRefTowerConfig value) {
      stream.Serialize(ref value.Id.Value);
    }
  }
  [System.SerializableAttribute()]
  ...
  [System.SerializableAttribute()]
  public unsafe partial class ProjectileConfig : AssetObject {
  }
  [System.SerializableAttribute()]
  public unsafe partial class TowerConfig : AssetObject {
  }
  public unsafe partial class ComponentPrototypeVisitor : Prototypes.ComponentPrototypeVisitorBase {
    ...
    public virtual void Visit(Prototypes.EndGoal_Prototype prototype) {
      VisitFallback(prototype);
    }
  ...
  public unsafe partial class TypeRegistry {
    partial void AddGenerated() {
      ...
      Register(typeof(Quantum.AssetRefProjectileConfig), Quantum.AssetRefProjectileConfig.SIZE);
      ...
      Register(typeof(Quantum.AssetRefTowerConfig), Quantum.AssetRefTowerConfig.SIZE);
      ...
      Register(typeof(Quantum.EndGoal), Quantum.EndGoal.SIZE);
      ...
      Register(typeof(Quantum.HealthContainer), Quantum.HealthContainer.SIZE);
  ...
  public unsafe partial class FramePrinterGen {
    public static void EnsureNotStripped() {
      ...
      FramePrinter.EnsurePrimitiveNotStripped<Quantum.AssetRefProjectileConfig>();
      ...
      FramePrinter.EnsurePrimitiveNotStripped<Quantum.AssetRefTowerConfig>();
...
namespace Quantum.Prototypes {
  ...
  [System.SerializableAttribute()]
  [Prototype(typeof(EndGoal))]
  public sealed unsafe partial class EndGoal_Prototype : ComponentPrototype<EndGoal> {
    [HideInInspector()]
    public Int32 _empty_prototype_dummy_field_;
    partial void MaterializeUser(Frame frame, ref EndGoal result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
      EndGoal component = default;
      Materialize((Frame)f, ref component, in context);
      return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref EndGoal result, in PrototypeMaterializationContext context) {
      MaterializeUser(frame, ref result, in context);
    }
    public override void Dispatch(ComponentPrototypeVisitorBase visitor) {
      ((ComponentPrototypeVisitor)visitor).Visit(this);
  ...
  [System.SerializableAttribute()]
  [Prototype(typeof(HealthContainer))]
  public sealed unsafe partial class HealthContainer_Prototype : ComponentPrototype<HealthContainer> {
    public FP Health;
    partial void MaterializeUser(Frame frame, ref HealthContainer result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
      HealthContainer component = default;
      Materialize((Frame)f, ref component, in context);
      return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref HealthContainer result, in PrototypeMaterializationContext context) {
  ...
  public sealed unsafe partial class SpawnPoint_Prototype : ComponentPrototype<SpawnPoint> {
    [HideInInspector()]
    public Int32 _empty_prototype_dummy_field_;
  ...
  public sealed unsafe partial class Tower_Prototype : ComponentPrototype<Tower> {
    public AssetRefTowerConfig Config;
  ...
  public unsafe partial class FlatEntityPrototypeContainer {
    ...
    [ArrayLength(0, 1)]
    public List<Prototypes.EndGoal_Prototype> EndGoal;
    [ArrayLength(0, 1)]
    ...
    public unsafe partial class StoreVisitor {
      ...
      public override void Visit(Prototypes.EndGoal_Prototype prototype) {
        Storage.Store(prototype, ref Storage.EndGoal);
      }
